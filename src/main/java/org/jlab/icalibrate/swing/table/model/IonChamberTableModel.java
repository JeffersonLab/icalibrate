...
public class IonChamberTableModel extends AbstractTableModel {
  ...
  private final List<String> columnNames = Arrays.asList("Name", "EPICS Name", "Include");
  ...
  /**
   * A table row model entity for holding ion chambers. <br>
   *
   * <p><b>Note:</b> a static nested class is behaviorally a top-level class that has been nested in
