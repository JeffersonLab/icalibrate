...
import org.jlab.icalibrate.swing.util.GenericButtonAreaLayout;

/**
 * A file chooser which prompts the user before allowing file overwrite.
 *
 * <p>This file chooser also lays out buttons with their preferred size as opposed to making the
 * width equal to the width of the widest button on the form.
 *
 * @author ryans
 */
  ...
  private void overrideButtonAreaLayout() {
    ...
    if (cancelButton != null) {
      ...
      LayoutManager buttonLayout =
          new GenericButtonAreaLayout(false, 6, SwingConstants.RIGHT, false);
  ...
  private JButton getFirstButtonByText(Container c, String text) {
    ...
    for (Component comp : c.getComponents()) {
      ...
      if (comp instanceof JButton
          && (temp = (JButton) comp).getText() != null
