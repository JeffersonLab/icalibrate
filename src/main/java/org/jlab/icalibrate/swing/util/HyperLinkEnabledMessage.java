 ...
 *
 * Note: this doesn't work on JLab Red Hat Linux boxes currently due to lack of support for Java
...
public class HyperLinkEnabledMessage extends JEditorPane {
    ...
    private static final Logger LOGGER = Logger.getLogger(
            HyperLinkEnabledMessage.class.getName());
            ...
            public void hyperlinkUpdate(HyperlinkEvent e) {
                ...
                if (type == HyperlinkEvent.EventType.ACTIVATED) {
                    ...
                    try {
                        ...
                        LOGGER.log(Level.WARNING, "Unable to launch web browser",
                                ex);
                        JOptionPane.showInputDialog(null, "Copy and paste URL (copy with CTRL-C): ",
                                "Unable to launch web browser",
                                JOptionPane.ERROR_MESSAGE, null, null, url.toString());
                    }
                }
            }
        });
