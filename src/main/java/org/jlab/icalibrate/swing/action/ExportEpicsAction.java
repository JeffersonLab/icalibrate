...
public final class ExportEpicsAction extends AbstractAction {
      ...
      new MinimumExecutionSwingWorker<Long, Void>() {
        ...
        protected Long doWithMinimumExecution() throws Exception {
          ...
          boolean writeAllowed =
              "true".equals(ICalibrateApp.APP_PROPERTIES.getProperty("WRITE_ALLOWED"));
            ...
            for (DoseRateTripSetpoint setpoint : setpointList) {
              ...
              try {
                ...
                throw new AppException(
                    "Unable to perform EPICS CA Put of PV: " + pv + " - " + e.getMessage(), e);
              } catch (TimeoutException e) {
                throw new AppException("Timeout waiting for EPICS CA Put of PV: " + pv, e);
              }
            }
          }
        ...
        protected void done() {
          try {
            ...
            if (lognumber != null) { // failing to create comparison elog is simply ignored
              ...
              String html =
                  "<html>Log number: <a href=\"" + url + "\">" + lognumber + "</a></html>";
  ...
  private Long sendComparisonElog() throws LogCertificateException, LogIOException {
    ...
    LinkedHashSet<ModifySetpointTableModel.ModifySetpointRow> rows =
        frame.getModifySetpointDialog().getData();
    ...
    String body =
        "<h3 style=\"font-weight: bold;\">Calibration Parameters</h3>"
            + "<table>"
            + "<tbody>"
            + "<tr><th>Hall:</th><td>"
