...
public class RangeSliderUI extends BasicSliderUI {
  ...
  private final Color rangeColor = Color.YELLOW;
  ...
  /**
   * Overrides superclass method to do nothing. Thumb painting is handled within the <code>paint()
   * </code> method.
   *
   * @param g The Graphics
   */
  ...
  /**
   * Sets the location of the upper thumb, and repaints the slider. This is called when the upper
   * thumb is dragged to repaint the slider. The <code>setThumbLocation()</code> method performs the
   * same task for the lower thumb.
   */
  ...
  /**
   * Listener to handle model change events. This calculates the thumb locations and repaints the
   * slider if the value change is not caused by dragging a thumb.
   */
  ...
  public class RangeTrackListener extends TrackListener {
    ...
    /** Create a new RangeTrackListener. */
