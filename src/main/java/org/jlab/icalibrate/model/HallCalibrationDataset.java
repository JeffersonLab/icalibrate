...
public class HallCalibrationDataset {
     ...
     */
    public HallCalibrationDataset(Hall hall, String target, String pass, String note, Date calibratedDate, String calibratedBy, List<IonChamberDataset> datasetList) {
        this.hall = hall;
        this.target = target;
        this.pass = pass;
        this.note = note;
